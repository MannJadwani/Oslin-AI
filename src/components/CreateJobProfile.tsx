          ...
          <div className="p-6 space-y-8">
            ...
            <div className="space-y-4">
                <div className="flex justify-between items-center">
                    ...
                    <Button type="button" variant="ghost" size="sm" onClick={() => setQuestions([...questions, { id: crypto.randomUUID(), text: "", timeLimit: undefined, allowRetake: true }])} className="rounded-xl text-slate-600 hover:text-slate-900 hover:bg-slate-100">
