...
export function InterviewerDashboard() {
  ...
  const [selectedProfile, setSelectedProfile] =
    useState<Id<"jobProfiles"> | null>(null);
  ...
  const isInterviewsTab =
    currentView === "interviews" || currentView === "candidates";
            ...
            <Card className="bg-white border-slate-100 shadow-sm rounded-2xl overflow-hidden hover:shadow-md transition-shadow">
              <CardHeader className="pb-3">
                ...
                <CardDescription className="text-slate-500 mt-2">
                  Create a new position description to start interviewing
                  candidates.
                </CardDescription>
              </CardHeader>
              <CardContent>
